 ...
 * itinerario ya ha sido almacenado en la base de datos el archivo se 
 * encontrará en la carpeta imagenes del directorio de la aplicación</li>
...
public class Itinerario implements Serializable {
    ...
    /**
     * Añade una lista de fechas a la lista de fechas de resolución del itinerario
     * @param fechas 
     */
